...
from lib.models.avtrack.vision_transformer import VisionTransformer, trunc_normal_, checkpoint_filter_fn
...
def deit_tiny_patch16_224_distill(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-tiny model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
