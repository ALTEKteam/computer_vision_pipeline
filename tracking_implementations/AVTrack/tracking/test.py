...
def main():
    ...
    parser.add_argument('tracker_name', type=str,default='avtrack' ,help='Name of tracking method.')
    parser.add_argument('tracker_param', type=str,default='deit_tiny_patch16_224' ,help='Name of config file.')
